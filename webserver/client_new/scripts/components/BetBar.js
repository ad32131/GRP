define([
    ...
    function calculatePlayingPercentages(engine) {
        ...
        return { //at1
            playingLost: bitsPlaying / totalAmountPlaying,
            cashedWon: bitsCashedOut / totalAmountPlaying,
            cashedWonAfter: bitsCashedOutAfterMe / totalAmountPlaying,
            me: myBet / totalAmountPlaying
        };
    }
});
