...
//Play 하단의 게임내역에 관련된 출력내용
			/*D.a({href: '/game/' + game.game_id, target: '_black', className: className},*/
                    D.td(null,
			D.a({ target: '_black', className: className},
                    ...
                    D.table({ className: 'games-log' },
                        D.thead(null,
                            D.tr(null,
                                ...
                                D.th(null, D.div({ className: 'th-inner'}, '게임배당')),
                                D.th(null, D.div({ className: 'th-inner'}, '유저배당')),
