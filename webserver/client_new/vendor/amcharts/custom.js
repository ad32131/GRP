    ...
    AmCharts.ready(function () {
        ...
        function frmt(x) {
            ...
            var r = "<table>" +
                ...
                "</td></tr>" +
                '<tr><th>베팅:</th><td>' + (entry.bet/100).toFixed() + ' KRW</td></tr>' +
                "<tr><th>게임결과:</th><td>" + (typeof entry.game_crash !== 'undefined' ? (entry.game_crash/100).toFixed(2) + 'x' : '?') + "</td></tr>" +
                "<tr><th>회원베팅:</th><td>" + (entry.cash_out ? (entry.cash_out / entry.bet).toFixed(2) + 'x' : '-') + "</td></tr>" +
                '<tr><th>보너스: </th><td>' + (entry.bonus ? (entry.bonus/100).toFixed(2) : 0) + ' KRW</td></tr>' +
                "<tr><th>순수익:</th><td><b>" + profit/100 /* (profit/100).toFixed(2)*/ + " KRW</b></td></tr>" +
                '</table>';
            return r;
